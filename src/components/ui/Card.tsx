...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-xs text-slate-500 font-normal leading-normal", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex items-center p-6 border-t border-slate-100 bg-slate-50/50 rounded-b-2xl", className)}
    {...props}
  />
));
