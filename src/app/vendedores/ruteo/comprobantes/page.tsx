  ...
  return (
    <div className="mx-auto max-w-[1500px] space-y-5 p-4 sm:p-6 lg:p-8">
      <header className="flex items-center gap-3">
        ...
        <Link href="/admin/configuracion-impresion" className="ml-auto inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2 text-xs font-bold text-slate-700 shadow-sm hover:border-blue-300 hover:text-blue-700"><Settings2 className="h-4 w-4" /> Configuración de categorías</Link>
      </header>
